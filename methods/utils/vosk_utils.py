...
def determine_words(audio_path: str, sr: int = SAMPLE_RATE):
    try:
        rec_wrapper = RecognizerWrapper(sr)
...
def get_neighbors(data, splice_samples: List[int], source_path='sample.wav'):
    global SAMPLE_RATE
